...
glm::vec3& Camera::getPositionVector() { return positionVector; }

glm::vec3& Camera::getTargetVector() { return targetVector; }

glm::vec3& Camera::getDirectionVector() { return directionVector; }

glm::vec3& Camera::getUpVector() { return upVector; }

glm::vec3& Camera::getRightVector() { return rightVector; }

glm::vec3& Camera::getDefaultUpVector() { return defaultUpVector; }

bool& Camera::isOnRotation() { return onRotation; }

GLfloat& Camera::getRotationDegree() { return rotationDegree; }
...
void Camera::update()
{
	...
	viewMatrix = glm::lookAt(positionVector, targetVector, upVector);
