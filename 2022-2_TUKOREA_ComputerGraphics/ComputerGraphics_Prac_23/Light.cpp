...
void Light::readObj(const char* fileName)
{
...
void Light::on() { lightColor = glm::vec3(1.0f, 1.0f, 1.0f); }

void Light::off() { lightColor = glm::vec3(0.0f, 0.0f, 0.0f); }

glm::vec3& Light::getLightColor() { return lightColor; }

glm::vec3& Light::getLightPos() { return lightPos; }

void Light::render(glm::mat4& parent) const
{
...
GLfloat& Light::getPosDegree() { return posDegree; }

GLfloat& Light::getLightPosDegree() { return lightPosDegree; }

bool& Light::isOnRight() { return onLight; }

GLfloat& Light::getMoveAmount() { return moveAMount; }

glm::vec3& Light::getDirectionVector() { return directionVector; }

bool& Light::isOnRevolution() { return onRevolution; }

Direction& Light::getRevolutionDirection() { return revolutionDirection; }

GLfloat& Light::getRevolutionDegree() { return revolutionDegree; }

glm::vec3& Light::getPositionVector() { return positionVector; }

LightColor& Light::getLightColorType() { return lightColorType; }