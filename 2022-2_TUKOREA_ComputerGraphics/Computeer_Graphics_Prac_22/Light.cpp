...
glm::vec3& Light::getLightPosition() { return lightPositionVector; }
...
void Light::render(glm::mat4& parent) const 
{
	...
	translationMatrix = glm::translate(translationMatrix, lightPositionVector);
...
GLfloat& Light::getRadian() { return radian; }

bool& Light::isOnRight() { return onLight; }

GLfloat& Light::getMoveAmount() { return moveAMount; }

bool& Light::isOnRevolution() { return revolutionTimer; }
