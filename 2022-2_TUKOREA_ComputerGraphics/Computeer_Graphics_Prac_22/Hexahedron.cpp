...
Hexahedron* Hexahedron::getInstance()
{
	if (nullptr == pInst)
...
void Hexahedron::readObj(const char* fileName)
{
...
GLfloat& Hexahedron::getRotationDegree() { return rotatationDegree; }

bool& Hexahedron::isOnRotation() { return onRotation; }

void Hexahedron::render(glm::mat4& parent) const
{
