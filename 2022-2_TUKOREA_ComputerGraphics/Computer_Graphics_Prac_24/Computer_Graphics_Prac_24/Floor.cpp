...
void Floor::initialize(const char* objName)
{
	positionVector = glm::vec3{ 0.0f,0.0f,0.0f };
	scaleVector = glm::vec3{ 3.5f, 0.0f, 3.5f };
	colorVector = glm::vec3{ 0.5f,0.5f,0.5f };
	readObj(objName);
}

void Floor::readObj(const char* objName)
{
