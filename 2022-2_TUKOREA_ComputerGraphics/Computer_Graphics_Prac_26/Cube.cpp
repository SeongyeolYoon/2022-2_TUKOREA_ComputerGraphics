...
Direction& Cube::getDirection() { return direction; }

Axis& Cube::getAxis() { return axis; }

bool& Cube::isOnRotation() { return onRotation; }

void Cube::readObj(const char* fileName)
{
...
void Cube::render(glm::mat4& parent)
{
	...
	for (size_t i = 0; i < 6; ++i) {
		...
		glDrawArrays(GL_TRIANGLES, i*6, 6); // 0¾Æ·§¸é 6À­¸é  12¾Õ¸é 18¿À¸¥ÂÊ 24µÚ  30¿Þ
	}
}
